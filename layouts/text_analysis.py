...
text_analysis_layout = html.Div(
    [
        ...
        html.P(
            ...
            analizing the text ofRedditposts (and wikipedia pages)? We'll present some results first - \
        ...
        html.P(
            ...
            nootropic in he world as an example: Caffeine. To begin with, let's generate wordclouds for its wikipedia entry and forRedditposts that mention it."
        ),
        html.H4("Cafeinated wordclouds"),
        html.P(
            "The wordclouds below are both generated by comparing how often\
             a given word appears in the wikipedia page/onRedditposts about a\
        ...
        html.P(
            "There are some interesting differences between the wordclouds generated from wikipedia and from Reddit:\
                       ...
                       Redditwordcloud - much more so than on the wiki one: 'focus', 'anxiety', 'stimulant', 'sleep', 'awake', 'crash', etc.\
...
def show_wordcloud_for_nootropic(chosen_nootropic):
    ...
    if len(wordclouds) == 1:
        children.append(
            dbc.Col(
                html.P(
                    "Note: The chosen nootropic was not found in theRedditnetwork, \
